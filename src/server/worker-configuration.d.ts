/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-configuration.d.ts` (hash: 12fc84be3c5ae4aee2395b15b4ee93a7)
// Runtime types generated with workerd@1.20260504.1 2025-10-08 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "Chat" | "Rooms";
	}
	interface Env {
		ASSETS: Fetcher;
