/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-configuration.d.ts` (hash: b5f1effabdef0251a645a4fe9936b977)
// Runtime types generated with workerd@1.20260504.1 2025-10-08 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "Chat" | "Rooms" | "Accounts";
	}
	interface Env {
		ASSETS: Fetcher;
		Chat: DurableObjectNamespace<import("./index").Chat>;
		Rooms: DurableObjectNamespace<import("./index").Rooms>;
		Accounts: DurableObjectNamespace<import("./index").Accounts>;
	}
}
